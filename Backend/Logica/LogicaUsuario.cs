    ...
    internal class LogicaUsuario
    {
        ...
        public ResAgregarUsuario agregarUsuario(ReqAgregarUsuario req)
        {
            ...
            if (resBase.tipoRegistro!=1 || !resBase.resultado)
            {
                ...
                res.resultadoTexto = resBase.resultadoTexto;
            ...
            else
            {
                ...
                {
                    res.resultadoTexto = "Datos Inconsistentes";
                    res.tipoRegistro = 3;
                    res.resultado = false;
                }
                else
                {
                    ...
                    try
                    {
                        ...
                        res.resultado = true;
                        res.resultadoTexto = "success";
                        res.tipoRegistro = 1;
                    }
                    catch (Exception e)
                    {
                        res.resultadoTexto = "Error de BD";
                        res.tipoRegistro = 4;
                        res.resultado = false;
                    }
                }
