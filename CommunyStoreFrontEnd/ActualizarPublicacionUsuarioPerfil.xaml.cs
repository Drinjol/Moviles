            ...
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        {
                            await DisplayAlert("Éxito", "Publicación actualizada con éxito", "OK");
                            await Navigation.PopAsync();
                        }
                        else
                        {
                            await DisplayAlert("Error", "Hubo un problema al actualizar la publicación: " + string.Join(", ", resActualizarPublicacion?.listaDeErrores), "OK");
                        }
                    }
                    else
                    {
                        await DisplayAlert("Error", "Hubo un problema al actualizar la publicación", "OK");
                    }
                }
            }
            catch (Exception ex)
