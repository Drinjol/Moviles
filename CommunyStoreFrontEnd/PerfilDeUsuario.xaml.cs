...
public partial class PerfilDeUsuario : ContentPage, INotifyPropertyChanged
{
    ...
    private async void Eliminar_Clicked(object sender, EventArgs e)
    {
        ...
        {
            bool confirmed = await DisplayAlert("Confirmaci�n", "Estas seguro de que desea eliminar esta publicacion?", "Si", "No");
            if (confirmed)
            {
                try
                {
        ...
        {
            await DisplayAlert("Error", "No se pudo obtener el ID de la publicaci�n.", "OK");
        }
